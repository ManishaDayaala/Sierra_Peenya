...
training_file_path = os.path.join(MAINFOLDER, "Training", "Training_burnishing.xlsx")  # FIXED TRAINING DATA
test_file_path = os.path.join(MAINFOLDER, "24hrData", "Dailydata_burnishing.xlsx")  # DAILY DATA
...
threshold_file_path = os.path.join(MAINFOLDER,"Thresholds_burnishing.xlsx") #
...
st.markdown(
    ...
    <div style="display: flex; align-items: center;">
        ...
        <span style="font-size: {title_font_size}px; font-weight: bold;">Breakdown Predictor-Sierra-2(peenya)</span>
    </div>
